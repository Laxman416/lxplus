...
# Model Signal
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0.3, 0.1, 0.4)
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 0.3, 0.1, 0.4)
frac_D0bar_up = RooRealVar("frac_D0bar_up", "frac_D0bar_up", 0.3, 0.1, 0.4)
frac_D0bar_down = RooRealVar("frac_D0bar_down", "frac_D0bar_down", 0.3, 0.1, 0.4)
