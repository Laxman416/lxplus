...
# Model CrystalBall
Csig = RooRealVar("Csig", "Csig", 6.2, 0, 20)
aL = RooRealVar("aL", "aL", 2.48, -10, 10)
nL = RooRealVar("nL", "nL", 9.7, -10, 10)
aR = RooRealVar("aR", "aR", 8.72, -10, 10)
nR = RooRealVar("nR", "nR", 3.92, -10, 10)
...
if binned:
    ...
    Nsig_D0_up = RooRealVar("Nsig_D0_up", "Nsig D0 up", 0.95*Binned_D0_up.numEntries(), 0.85*Binned_D0bar_up.numEntries(), Binned_D0_up.numEntries())
    Nbkg_D0_up = RooRealVar("Nbkg_D0_up", "Nbkg D0 up", 0.05*Binned_D0_up.numEntries(), 0, 0.15*Binned_D0_up.numEntries())
    ...
    Nsig_D0_down = RooRealVar("Nsig_D0_down", "Nsig D0 down", 0.95*Binned_D0_down.numEntries(), 0.85*Binned_D0bar_up.numEntries(), Binned_D0_down.numEntries())
    Nbkg_D0_down = RooRealVar("Nbkg_D0_down", "Nbkg D0 down", 0.05*Binned_D0_down.numEntries(), 0, 0.15*Binned_D0_down.numEntries())
    ...
    Nsig_D0bar_up = RooRealVar("Nsig_D0bar_up", "Nsig D0bar up", 0.95*Binned_D0bar_up.numEntries(), 0.85*Binned_D0bar_up.numEntries(), Binned_D0bar_up.numEntries())
    Nbkg_D0bar_up = RooRealVar("Nbkg_D0bar_up", "Nbkg D0bar up", 0.05*Binned_D0bar_up.numEntries(), 0, 0.15*Binned_D0bar_up.numEntries())
    ...
    Nsig_D0bar_down = RooRealVar("Nsig_D0bar_down", "Nsig D0bar down", 0.95*Binned_D0bar_down.numEntries(), 0.85*Binned_D0bar_up.numEntries(), Binned_D0bar_down.numEntries())
    Nbkg_D0bar_down = RooRealVar("Nbkg_D0bar_down", "Nbkg D0bar down", 0.05*Binned_D0bar_down.numEntries(), 0, 0.15*Binned_D0bar_down.numEntries())
