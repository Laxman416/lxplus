...
sigma = RooRealVar("sigma", "sigma", 6.3, 0, 100)
gaussian = RooGaussian("gauss", "gauss", D0_M, mean, sigma)

# Model CrystalBall
Csig = RooRealVar("Csig", "Csig", 9.6, 0, 100)
aL = RooRealVar("aL", "aL", 1.72, -10, 10)
nL = RooRealVar("nL", "nL", 16, -40, 40)
aR = RooRealVar("aR", "aR", 2.3, -10, 10)
nR = RooRealVar("nR", "nR", 28, -40, 40)
...
# Model Signal
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0.45, 0, 1)
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 0.45, 0, 1)
frac_D0bar_up = RooRealVar("frac_D0bar_up", "frac_D0bar_up", 0.45, 0, 1)
frac_D0bar_down = RooRealVar("frac_D0bar_down", "frac_D0bar_down", 0.45, 0, 1)
