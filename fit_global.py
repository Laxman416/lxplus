...
sigma = RooRealVar("sigma", "sigma", 7.9, 0, 100)
gaussian = RooGaussian("gauss", "gauss", D0_M, mean, sigma)

# Model CrystalBall
Csig = RooRealVar("Csig", "Csig", 5.4, 0, 100)
aL = RooRealVar("aL", "aL", 1.48, -30, 30)
nL = RooRealVar("nL", "nL", 9, -30, 30)
aR = RooRealVar("aR", "aR", 6.91, -30, 30)
nR = RooRealVar("nR", "nR", 3.92, -30, 30)
...
# Model Signal
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0.62, 0, 0.8)
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 0.62, 0, 0.8)
frac_D0bar_up = RooRealVar("frac_D0bar_up", "frac_D0bar_up", 0.62, 0, 0.8)
frac_D0bar_down = RooRealVar("frac_D0bar_down", "frac_D0bar_down", 0.62, 0, 0.8)
