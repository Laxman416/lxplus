...
if binned:
    ...
    Nsig_D0_up = RooRealVar("Nsig_D0_up", "Nsig D0 up", 0.5*Binned_D0_up.numEntries(), 0, Binned_D0_up.numEntries())
    ...
    Nsig_D0_down = RooRealVar("Nsig_D0_down", "Nsig D0 down", 0.5*Binned_D0_down.numEntries(), 0, Binned_D0_down.numEntries())
    ...
    Nsig_D0bar_up = RooRealVar("Nsig_D0bar_up", "Nsig D0bar up", 0.5*Binned_D0bar_up.numEntries(), 0, Binned_D0bar_up.numEntries())
    ...
    Nsig_D0bar_down = RooRealVar("Nsig_D0bar_down", "Nsig D0bar down", 0.5*Binned_D0bar_down.numEntries(), 0, Binned_D0bar_down.numEntries())
