...
# Model CrystalBall
Csig = RooRealVar("Csig", "Csig", 5.9, 4, )
aL = RooRealVar("aL", "aL", 2.47, -10, 10)
nL = RooRealVar("nL", "nL", 8.4, -10, 10)
aR = RooRealVar("aR", "aR", 8.71, -10, 10)
nR = RooRealVar("nR", "nR", 3.91, -20, 20)
...
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 0.5, 0.6, 0.75)
frac_D0bar_up = RooRealVar("frac_D0bar_up", "frac_D0bar_up", 0.5, 0.6, 0.75)
frac_D0bar_down = RooRealVar("frac_D0bar_down", "frac_D0bar_down", 0.5, 0.6, 0.75)
...
if binned:
    ...
    Nsig_D0_up = RooRealVar("Nsig_D0_up", "Nsig D0 up", 0.95*Binned_D0_up.numEntries(), 0.8*Binned_D0_up.numEntries(), Binned_D0_up.numEntries())
    Nbkg_D0_up = RooRealVar("Nbkg_D0_up", "Nbkg D0 up", 0.05*Binned_D0_up.numEntries(), 0, 0.2*Binned_D0_up.numEntries())
