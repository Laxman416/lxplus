...
# Model CrystalBall
Csig = RooRealVar("Csig", "Csig", 9.2, 0, 20)
aL = RooRealVar("aL", "aL", 5.7, -20, 20)
nL = RooRealVar("nL", "nL", 8.7, -20, 20)
aR = RooRealVar("aR", "aR", 2.3, -20, 20)
nR = RooRealVar("nR", "nR", 4.1, -20, 20)
...
# Model Signal
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0.62, 0.3, 0.65)
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 0.62, 0.3, 0.65)
frac_D0bar_up = RooRealVar("frac_D0bar_up", "frac_D0bar_up", 0.62, 0.3, 0.65)
frac_D0bar_down = RooRealVar("frac_D0bar_down", "frac_D0bar_down", 0.62, 0.3, 0.65)
...
if binned:
    ...
    Nsig_D0_up = RooRealVar("Nsig_D0_up", "Nsig D0 up", 0.95*Binned_D0_up.numEntries(), 0.5*Binned_D0bar_up.numEntries(), Binned_D0_up.numEntries())
    Nbkg_D0_up = RooRealVar("Nbkg_D0_up", "Nbkg D0 up", 0.05*Binned_D0_up.numEntries(), 0, 0.3*Binned_D0_up.numEntries())
    ...
    Nsig_D0_down = RooRealVar("Nsig_D0_down", "Nsig D0 down", 0.95*Binned_D0_down.numEntries(), 0.5*Binned_D0bar_up.numEntries(), Binned_D0_down.numEntries())
    Nbkg_D0_down = RooRealVar("Nbkg_D0_down", "Nbkg D0 down", 0.05*Binned_D0_down.numEntries(), 0, 0.3*Binned_D0_down.numEntries())
    ...
    Nsig_D0bar_up = RooRealVar("Nsig_D0bar_up", "Nsig D0bar up", 0.95*Binned_D0bar_up.numEntries(), 0.5*Binned_D0bar_up.numEntries(), Binned_D0bar_up.numEntries())
    Nbkg_D0bar_up = RooRealVar("Nbkg_D0bar_up", "Nbkg D0bar up", 0.05*Binned_D0bar_up.numEntries(), 0, 0.3*Binned_D0bar_up.numEntries())
    ...
    Nsig_D0bar_down = RooRealVar("Nsig_D0bar_down", "Nsig D0bar down", 0.95*Binned_D0bar_down.numEntries(), 0.5*Binned_D0bar_up.numEntries(), Binned_D0bar_down.numEntries())
    Nbkg_D0bar_down = RooRealVar("Nbkg_D0bar_down", "Nbkg D0bar down", 0.05*Binned_D0bar_down.numEntries(), 0, 0.3*Binned_D0bar_down.numEntries())
