...
sigma = RooRealVar("sigma", "sigma", 6.42, 0, 20)
gaussian = RooGaussian("gauss", "gauss", D0_M, mean, sigma)

# Model CrystalBall
Csig = RooRealVar("Csig", "Csig", 10.24, 0, 40)
aL = RooRealVar("aL", "aL", 1.70, -10, 10)
nL = RooRealVar("nL", "nL", 8.4, -20, 20)
aR = RooRealVar("aR", "aR", -5, -10, 10)
nR = RooRealVar("nR", "nR", 8.16, -20, 20)
...
# Model Signal
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0.567,0.4,0.7)
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 0.567,0.4,0.7)
frac_D0bar_up = RooRealVar("frac_D0bar_up", "frac_D0bar_up", 0.567,0.4,0.7)
frac_D0bar_down = RooRealVar("frac_D0bar_down", "frac_D0bar_down", 0.567,0.4,0.7)
