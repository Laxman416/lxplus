...
sigma = RooRealVar("sigma", "sigma", 8.39, 0, 40)
gaussian = RooGaussian("gauss", "gauss", D0_M, mean, sigma)

# Model CrystalBall
Csig = RooRealVar("Csig", "Csig", 5.9, 4, 6.2)
aL = RooRealVar("aL", "aL", 5.48, -10, 10)
nL = RooRealVar("nL", "nL", 0.13, -10, 10)
aR = RooRealVar("aR", "aR", 8.04, -10, 10)
...
# Model Signal
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0, 0.7, 1)
