...
if global_local:
    ttree.Add(f"{options.input}/{options.meson}_data_{options.polarity}_{options.year}_{options.size}_bin{options.bin}.root")
else:
    ttree.Add(f"{options.input}/{options.meson}_data_{options.polarity}_{options.year}_{options.size}_clean.root")
